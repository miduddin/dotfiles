...
set(0, "@keyword.return", { fg = c.func, italic = true })
...
set(0, "@type.builtin", { link = "@variable.builtin" })
set(0, "@type.declaration", { fg = c.constant })
...
set(0, "StatusLine", { fg = c.fg, bg = c.comment })
set(0, "StatusLineNC", { fg = c.comment, bg = c.bg })
set(0, "StatusLineTerm", { fg = c.fg, bg = c.line })
set(0, "StatusLineTermNC", { fg = c.comment, bg = c.line })
...
set(0, "iCursor", { reverse = true })
set(0, "lCursor", { reverse = true })
set(0, "vCursor", { reverse = true })
...
set(0, "NeotestDir", { fg = c.comment })
set(0, "NeotestFailed", { fg = c.error })
set(0, "NeotestFile", { fg = c.constant })
...
set(0, "NeotestTest", { fg = c.comment })
set(0, "NeotestUnknown", { fg = c.fg })
