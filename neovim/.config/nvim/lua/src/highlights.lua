...
set(0, "@string.special.url", { fg = M.syn.special, undercurl = true })
...
set(0, "BlinkCmpKindCopilot", { link = "String" })
set(0, "BlinkCmpKindDefault", { fg = M.ui.fg })
set(0, "BlinkCmpKindEnum", { link = "Type" })
set(0, "BlinkCmpKindEnumMember", { link = "Constant" })
set(0, "BlinkCmpKindEvent", { link = "Type" })
set(0, "BlinkCmpKindField", { link = "@variable.member" })
...
set(0, "BlinkCmpKindText", { fg = M.ui.fg })
set(0, "BlinkCmpKindTypeParameter", { link = "Type" })
set(0, "BlinkCmpKindUnit", { link = "Number" })
set(0, "BlinkCmpKindValue", { link = "String" })
set(0, "BlinkCmpKindVariable", { fg = M.ui.fg })
set(0, "BlinkCmpMenuBorder", { fg = M.ui.float.fg_border, bg = M.ui.bg_gutter })
