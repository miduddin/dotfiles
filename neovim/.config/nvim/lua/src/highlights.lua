...
set(0, "MiniTablineCurrent", { link = "StFilename" })
set(0, "MiniTablineFill", { link = "TabLineFill" })
set(0, "MiniTablineHidden", { fg = M.ui.special, bg = M.ui.bg_float })
set(0, "MiniTablineModifiedCurrent", { link = "MiniTablineCurrent" })
set(0, "MiniTablineModifiedHidden", { link = "MiniTablineHidden" })
set(0, "MiniTablineModifiedVisible", { link = "MiniTablineVisible" })
