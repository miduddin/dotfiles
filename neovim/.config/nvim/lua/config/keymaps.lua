...
map("gc", "<C-/>", "v", { desc = "Toggle comment", remap = true })
map("gcc", "<C-/>", "n", { desc = "Toggle comment", remap = true })
...
vim.api.nvim_create_autocmd("LspAttach", {
	...
	callback = function(ev)
		...
		map(vim.lsp.buf.signature_help, "<C-S>", "i", { desc = "Signature help", buffer = ev.buf })
