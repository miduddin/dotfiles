local function add_row_below()
	...
	local text_next = require("my.utils").get_line(line_current)
...
Map("<Leader>.r", require("my.utils").dot_repeat(add_row_below), "n", { expr = true })
...
Map("<Leader>.c", require("my.utils").dot_repeat(align_columns), "n", { expr = true })
